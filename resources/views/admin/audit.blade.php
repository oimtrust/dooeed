...
<div class="col-md-5"><label class="form-label" for="admin_id">Admin ID</label><input class="form-control" id="admin_id" name="admin_id" placeholder="UUID admin"></div>
<div class="col-md-5"><label class="form-label" for="target_user_id">User ID</label><input class="form-control" id="target_user_id" name="target_user_id" placeholder="UUID user"></div>
